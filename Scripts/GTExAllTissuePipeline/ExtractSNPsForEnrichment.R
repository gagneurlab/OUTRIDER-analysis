...
#'   threads: 10
#'   input: 
#'     - subvcfannotbi: '`sm config["DATADIR"] + "/GTEx_variant_enrichment/rareModerateNHighVariants.vcf.gz.tbi"`'
#'     - subvcfgttbi:   '`sm config["DATADIR"] + "/GTEx_variant_enrichment/rareModerateNHighVariants_gt.vcf.gz.tbi"`'
#'   output:
...
#' Debug input
inputVCFAnno <- "Output/data/GTEx_variant_enrichment/rareModerateNHighVariants.vcf.gz"
inputVCFGT   <- "Output/data/GTEx_variant_enrichment/rareModerateNHighVariants_gt.vcf.gz"
outputTSV    <- "Output/data/GTEx_variant_enrichment/rareModerateNHighVariantsTable.tsv"
...
# csqdt <- table(csqdt[,any(is.na(CCDS)), by=variantID][,V1])
length(unique(csqdt$variantID))
